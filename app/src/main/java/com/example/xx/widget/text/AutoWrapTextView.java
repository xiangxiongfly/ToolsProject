package com.example.xx.widget.text;
...
public class AutoWrapTextView extends View {
    ...
    private char[] mTextCharArray;//文本char数组
    private int mSingleTextWidth;//单行文本显示宽度
    private List<String> mSplitTextList;//拆分后的文本集合
    private Rect[] mSplitTextRectArray = null;//拆分后的文本rect数组
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.AutoWrapTextView);
        ...
        mText = typedArray.getString(R.styleable.AutoWrapTextView_text);
        mTextColor = typedArray.getColor(R.styleable.AutoWrapTextView_textColor, Color.BLACK);
        mTextSize = typedArray.getDimensionPixelSize(R.styleable.AutoWrapTextView_textSize, 50);
        mLineSpacingExtra = typedArray.getInteger(R.styleable.AutoWrapTextView_lineSpacingExtra, 7);
