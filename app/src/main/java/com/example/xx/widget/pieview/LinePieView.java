package com.example.xx.widget.pieview;
...
//        typedArray.recycle();
    ...
    private void calculateAndDraw(Canvas canvas) {
        ...
        for (int i = 0; i < numbers.length; i++) {
            ...
            drawData(canvas, arcCenterDegree, i, percent,colors[i]);
        }
        //绘制中心数字总和
     ...
     * @param percent 数据百分比
     */
    private void drawData(Canvas canvas, float degree, int i, float percent, int colorInt) {
        //弧度中心坐标
